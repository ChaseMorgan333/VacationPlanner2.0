...
public class ExcursionDatePickerFragment extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    ExcursionDetails excursionDetails;
    ExcursionDatePickerFragment(ExcursionDetails excursionDetails){
